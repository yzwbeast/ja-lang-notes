...
|    | **や (ya)** | **ゆ (yu)** | **よ (yo)** |
|----|----|----|----|
| **k** (k 行) | きゃ (kya) | きゅ (kyu) | きょ (kyo) |
| **s** (s 行) | しゃ (sha) | しゅ (shu) | しょ (sho) |
| **c** (t 行) | ちゃ (cha) | ちゅ (chu) | ちょ (cho) |
| **n** (n 行) | にゃ (nya) | にゅ (nyu) | にょ (nyo) |
| **h** (h 行) | ひゃ (hya) | ひゅ (hyu) | ひょ (hyo) |
| **m** (m 行) | みゃ (mya) | みゅ (myu) | みょ (myo) |
| **r** (r 行) | りゃ (rya) | りゅ (ryu) | りょ (ryo) |
| **g** (g 行) | ぎゃ (gya) | ぎゅ (gyu) | ぎょ (gyo) |
| **j** (z 行) | じゃ (ja) | じゅ (ju) | じょ (jo) |
| **b** (b 行) | びゃ (bya) | びゅ (byu) | びょ (byo) |
| **p** (p 行) | ぴゃ (pya) | ぴゅ (pyu) | ぴょ (pyo) |
